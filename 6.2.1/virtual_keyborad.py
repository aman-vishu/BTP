...
# Load sounds
sound = pyglet.media.load("gaze_controlled_keyboard_p10/sound.wav", streaming=False)
left_sound = pyglet.media.load("gaze_controlled_keyboard_p10/left.wav", streaming=False)
right_sound = pyglet.media.load("gaze_controlled_keyboard_p10/right.wav", streaming=False)
